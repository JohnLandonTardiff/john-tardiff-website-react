                ...
                <div className="drawer-content">
                    ...
                    <div className="navbar bg-base-300">
                        <div className="flex-1">
                            <p>John Landon Tardiff - {getTitle()}</p>
                        </div>
                    ...
                    <footer className="footer footer-center p-6 bg-base-300">
                        <nav>
                            <div className="grid grid-flow-col gap-10">
                                <a href="mailto:jlandontardiff@gmail.com" target="_blank">
                                ...
                                <a href="https://www.linkedin.com/in/john-tardiff-b9231721a" target="_blank">
                                ...
                                <a href="https://github.com/JohnLandonTardiff?tab=repositories" target="_blank">
