            ...
            <div className="drawer">
                    ...
                    <div className="layout-container">
                        <div className="navbar bg-base-300 min-h-max">
                            <div className="navbar-start">
                                <label htmlFor="navbar-drawer" classname="btn btn-primary drawer-button">
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4">
                        <li><a id="about-me-tab" className="tab nav-tab drawer-button" href="/about-me">About Me</a></li>
                        <li><a id="experience-tab" className="tab nav-tab drawer-button" href="/experience">Experience</a></li>
                        <li><a id="resume-tab" className="tab nav-tab drawer-button" href="/resume">Resume</a></li>
                        <li><a id="contact-tab" className="tab nav-tab drawer-button" href="/contact">Contact</a></li>
                    </ul>
                </div>
            </div>
        )
