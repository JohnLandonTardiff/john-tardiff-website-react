        ...
        <div>
            <div className="card bg-base-100 content-card">
                <div className="card-body">
                    ...
                    <img className="w-full h-full rounded-lg shadow-2xl"  src={Headshot}/>
            ...
            <div className="card bg-base-100 content-card">
                <div className="card-body">
                    ...
                    <img className="w-full h-full rounded-lg shadow-2xl"  src={AboutMePic}/>
                    <p className="text-base indent-10">
            ...
            <div className="card bg-base-100 content-card">
                <div className="card-body">
                    <p className="text-2xl">WHAT I LIKE TO DO</p>
                    <img className="w-full h-full rounded-lg shadow-2xl"  src={Interests}/>
                    <p className="text-base indent-10">
